import {findTrackedItemWithLowestPrice, onePricePerDay, shortenNameIfTooLong} from "../../utils/item.util";
...
test("shorten name if too long", () => {
    expect(shortenNameIfTooLong("testing")).toBe("testing")
    expect(shortenNameIfTooLong("testing", 7)).toBe("test...")
})
