...
import {findTrackedItemWithLowestPrice, getWhiteListedTrackedItemsForItem,} from "../../../utils/item.util";
        ...
        >
            ...
            <DialogContent id={"shopping-list-dialog-slide-description-" + id}>
                {lines === null || lines.length === 0 ? (
                    ...
                    <ul className={"shopping-list-dialog-products"}>
                        {lines.map((line) => (
                            ...
                            >
                                <div>
                                    <ShoppingListItemCheckBox listId={id} itemId={line.item.id} value={requireRefresh}/>
                                </div>
                                <div>
                ...
                <div className={"flexElements spaceBetweenElements"}>
                    ...
                    <Button color={"primary"} onClick={unselectAll} disabled={!anyChecked}>Deselecteer alles</Button>
                </div>
            </DialogContent>
        </Dialog>
    );
